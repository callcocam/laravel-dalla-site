...
class CHOICE extends AbstractFields
{
    ...
    public function entity(string $entity, $collumns = ['id as value', 'name as label'])
    {
        ...
        if (class_exists($entity)) {
            ...
            $options = $this->getModel()->query()->select($collumns)->get()->toArray();
        }
